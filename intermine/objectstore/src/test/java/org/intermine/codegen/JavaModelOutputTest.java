...
public class JavaModelOutputTest extends TestCase
{
    ...
    public void testGenerateClassDescriptorImplementsInterfaces() throws Exception {
        ClassDescriptor cld1 = new ClassDescriptor("package.name.Interface1", null, null, true, new HashSet(), new HashSet(), new HashSet());
        ClassDescriptor cld2 = new ClassDescriptor("package.name.Interface2", null, null, true, new HashSet(), new HashSet(), new HashSet());
        ClassDescriptor cld3 = new ClassDescriptor("package.name.Class1", "package.name.Interface1 package.name.Interface2", null, false, new HashSet(), new HashSet(), new HashSet());
    ...
    public void testGetType() throws Exception {
        ...
        Set refs = new HashSet(Collections.singleton(rfd1));
        Set cols = new HashSet(Collections.singleton(cod1));
        ClassDescriptor cld1 = new ClassDescriptor("package.name.Class1", null, null, false, new HashSet(), refs, cols);
        ClassDescriptor cld2 = new ClassDescriptor("package.name.Class2", null, null, false, new HashSet(), new HashSet(), new HashSet());
        Model model = new Model("model", "package.name", new HashSet(Arrays.asList(new Object[] {cld1, cld2})));
    ...
    public void testGenerateMultiInheritanceLegal() throws Exception {
        ...
        ClassDescriptor cld1 = new ClassDescriptor("package.name.Class1", null, null, true, atds1, new HashSet(), new HashSet());
        ClassDescriptor cld2 = new ClassDescriptor("package.name.Class2", null, null, true, atds2, new HashSet(), new HashSet());
        ClassDescriptor cld3 = new ClassDescriptor("package.name.Class3", "package.name.Class1 package.name.Class2", null, false, new HashSet(), new HashSet(), new HashSet());
        Model model = new Model("model", "package.name", new HashSet(Arrays.asList(new Object[] {cld1, cld2, cld3})));
